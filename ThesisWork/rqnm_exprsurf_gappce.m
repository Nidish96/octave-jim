...
%     end
    ...
    save(sprintf('./GAPPCE/gappce_%d_N%d.mat', ip, Nq_pce), 'Qs', 'Phi', 'Lams', 'Zts', 'Wstat', 'Ustat');
...
load(sprintf('./GAPPCE/gappce_%d_N%d.mat', 1, 10), 'Qs')
...
for iq=1:Nq_pce
    load(sprintf('./GAPPCE/gappce_%d_N%d.mat', iq, Nq_pce), 'Qs', 'Lams', 'Zts', 'Phi', 'Wstat')
...
save(sprintf('./GAPPCE/gappce_N%d_cofs.mat', Nq_pce), 'Qs', 'Rcofs', 'Wcofs', 'Zcofs', 'Wstatcofs', 'Integs', 'wxps', 'zxps', 'rxps', 'wsxps')
...
set(gcf, 'Color', 'white')
for iq=1:Nq_pce
    load(sprintf('./GAPPCE/gappce_%d_N%d.mat', iq, Nq_pce), 'Qs', 'Lams', 'Zts', 'Phi')
...
save(sprintf('./GAPPCE/gappce_N%d_cofs.mat', Nq_pce), 'Qs', 'Rcofs', 'Wcofs', 'Zcofs', 'Integs')
...
% legend([ad am sm em], 'Model Evaluations', 'Mean of PCE', 'PCE
% Mean $\pm$ 3 Std. Dev.', 'Experimental Measurement', 'Location',
% 'southwest')
em = semilogx(AMP_avg(AMP_avg>=amin), FRE_avg(AMP_avg>=amin), 'k-', 'LineWidth', 2);
...
sgtitle('PCE Results for Gap Variation')
export_fig('./GAPPCE/BBFIG.png', '-dpng')
