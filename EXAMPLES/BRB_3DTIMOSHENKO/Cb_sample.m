...
% Beam Neutral Axis
Xna = SensorLocs([1; 2; 6; 10; 14; 18], 1);
Ux = 0.25*(Urecs{f_idx}([1; 2; 6; 10; 14; 18]*3-3+1,ti)+...
    Urecs{f_idx}([1; 3; 7; 11; 15; 18]*3-3+1,ti)+...
    Urecs{f_idx}([1; 4; 8; 12; 16; 18]*3-3+1,ti)+...
    Urecs{f_idx}([1; 2; 9; 13; 17; 18]*3-3+1,ti));
Uy = 0.25*(Urecs{f_idx}([1; 2; 6; 10; 14; 18]*3-3+2,ti)+...
    Urecs{f_idx}([1; 3; 7; 11; 15; 18]*3-3+2,ti)+...
    Urecs{f_idx}([1; 4; 8; 12; 16; 18]*3-3+2,ti)+...
    Urecs{f_idx}([1; 2; 9; 13; 17; 18]*3-3+2,ti));
Uz = 0.25*(Urecs{f_idx}([1; 2; 6; 10; 14; 18]*3-3+3,ti)+...
    Urecs{f_idx}([1; 3; 7; 11; 15; 18]*3-3+3,ti)+...
    Urecs{f_idx}([1; 4; 8; 12; 16; 18]*3-3+3,ti)+...
    Urecs{f_idx}([1; 2; 9; 13; 17; 18]*3-3+3,ti));
